...
describe('func-get-params', () => {
  ...
  it('should throw an Error when opts.language isn\'t \'js\', \'coffee\', or \'ts\'', () => {
    const testFunction = () => funcGetParams('fileContents', 'function', {language: 'english'})
  ...
  it('should throw a TypeError when contents isn\'t a string', () => {
    const testFunction = () => funcGetParams()
  ...
  it('should throw a TypeError when functionName isn\'t a string', () => {
    const testFunction = () => funcGetParams('fileContents')
  ...
  it('should throw an Error when functionName has whitespace', () => {
    const testFunctionSpace = () => funcGetParams('fileContents', ' ')

    const testFunctionTab = () => funcGetParams('fileContents', '  ')

    const testFunctionNewline = () => funcGetParams('fileContents', '\n')
  ...
  it('should throw an error when functionName isn\'t in fileContents', () => {
    const testFunction1 = () => funcGetParams('fileContents', 'functionName')

    const testFunction2 = () => funcGetParams('fileContents', 'funcName')
