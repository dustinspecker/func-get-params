...
describe('func-get-params', () => {
  ...
  describe('TypeScipt', () => {
    ...
    it('should return 1 param with type', () => {
      const fileContents = 'function config(x: int) {}';
